            ...
            <div class="card">
                ...
                <form action="{{ route('movieAdd') }}" method="POST">
                    ...
                    <div class="mb-3">
                      ...
                      <input type="text" class="form-control" name="duration" id="duration" aria-describedby="" placeholder="">
                    </div>
                    ...
                    <div class="mb-3">
                      ...
                      <input type="text" class="form-control" name="poster" id="poster" aria-describedby="helpId" placeholder="">
                    </div>

                    <div class="mb-3">
                      <label for="trailer" class="form-label">Trailer Url</label>
                      <input type="text" class="form-control" name="trailer" id="trailer" aria-describedby="helpId" placeholder="">
                    </div>
